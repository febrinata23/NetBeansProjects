...
public class Kuliah extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Mahasiswa mahasiswa = new Mahasiswa(Integer.parseInt(jTextField4.getText()),jTextField5.getText());
        Connection conn = null;
        IDm++;
        try {
            conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/db_test1?"+"user=root&password=");
            Statement state =  (Statement) conn.createStatement();
            String sql = "insert into mahasiswa values('"+IDm+"','"+mahasiswa.getNim()+"','"+mahasiswa.getNama()+"');";
            state.execute(sql);
            state.close();
            conn.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kuliah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
